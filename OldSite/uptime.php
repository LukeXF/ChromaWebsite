<?php
//                                                                                  //
// UPTIME MONITORED VIA GALATIC SERVERS ADMIN PANEL DO NOT EDIT THIS PAGE IN ANYWAY //
//    We use this to track uptime, status, ram & drive space of your services.      //
//      Want to know more? Then contact Luke at https://galacticservers.com         //
//                                                                                  //
...
<div class="progress-bar progress-bar-'.$memlevel.'" style="width: '.$memory.';">'.$memory.' left</div>
</div>';
...
<div class="progress-bar progress-bar-'.$hddlevel.'" style="width: '.$hdd.';">'.$hdd.' left</div>
</div>';

$load = sys_getloadavg();
$array['load'] = $load[0];

$array['online'] = '<div class="label label-success">
<div class="label label-success" style="width: 100%;"><small>   Server Online   </small></div>
</div>';
