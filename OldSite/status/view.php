<?php
	// Edit this ->
	define( 'MQ_SERVER_ADDR', 'chromahills.net' );
...
<body>
    <div class="container">
    	<div class="jumbotron">
			<h1>Chroma Hills Server Query</h1>

			<p>This class was created to query Minecraft servers. It works starting from Minecraft 1.0.</p>

			<p>
				<a class="btn btn-large btn-primary" href="http://chromahills.net">Server Site</a>
				<a class="btn btn-large btn-primary" href="https://chromahills.info">Server Panel</a>
				<a class="btn btn-large btn-danger" href="http://luke.sx">Luke.sx</a>
			</p>
		</div>
